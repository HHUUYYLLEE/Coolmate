...
const Home = () => {
  ...
  return (
    <div style={{width: "100%"}}>
        ...
        <div className={"n-1-1"} style={{position: "relative"}}>
            <div style={{width: "100%", display: "flex", justifyContent: 'space-evenly', alignItems: "center", position: "absolute", top: -120, zIndex: 999}}>
                <div style={{flex: '1 1 0', padding: 10}}>
                    <div className={"c-flex-center hover_button"} style={{width: '80%', marginLeft: 150, cursor:"pointer", padding: 10, height: 50, borderRadius: 10, border: "1px solid #fff", flexDirection: "column", gap: 5}}>
                ...
                <div style={{flex: '1 1 0', padding: 10}}>
                    <div className={"c-flex-center hover_button"} style={{marginLeft: 60, cursor:"pointer", width: '80%', padding: 10, height: 50, borderRadius: 10, border: "1px solid #fff", flexDirection: "column", gap: 5}}>
                        <div style={{textAlign: "center", fontSize: 14, fontWeight: 600}}>
                            60 ngày đổi trả
                        </div>
                        <div style={{textAlign: "center", fontSize: 14, fontWeight: 600}}>
                ...
                <div style={{flex: '1 1 0', padding: 10}}>
                    <div className={"c-flex-center  hover_button"} style={{marginLeft: -25, cursor:"pointer", width: '80%', padding: 10, height: 50, borderRadius: 10, border: "1px solid #fff", flexDirection: "column", gap: 5}}>
                        <div style={{textAlign: "center", fontSize: 14, fontWeight: 600}}>
        ...
        <div style={{marginTop: 45, width: "100%"}}>
            ...
            <div className={"c-flex-center"} style={{width: "100%"}}>
                <div style={{ position: "relative"}}>
                    ...
                    }} className={"s-1-1"} value={searchQuery} type="text" style={{width: 700, height: 50, borderRadius: 10, outlineColor: "#2e89ff", padding: 10}} placeholder={`Hãy thử bắt đầu với "Quần đen" xem sao`} />
                    {openSearch=== true && <img onClick={()=> {
        ...
        <div>
            <div className={"t-1-1"} style={{textAlign: "center", fontSize: 96, fontWeight: 600, marginBottom: 30}}>
                Coolmate Basics
            </div>
